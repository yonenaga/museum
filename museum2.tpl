...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark mt-3 mb-3  justify-content-center">
	<ul class="navbar-nav">
		<li class="nav-item dropdown">
			...
			<div class="dropdown-menu">
	            {section name=i loop=$label}
	            	<a class="dropdown-item" href='{$URL}?mode=1&title={$label[i]}&pref={$pref[i]}'>{$label[i]}</a>
	            {/section}
			</div>
		</li>
		<li class="nav-item dropdown">
			...
			<div class="dropdown-menu">
	            {section name=i loop=$label}
	            	<a class="dropdown-item" href='{$URL}?mode=2&title={$label[i]}&pref={$pref[i]}'>{$label[i]}</a>
	            {/section}
			</div>
		</li>
		<li class="nav-item dropdown">
			<a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">VIEW</a>
			<div class="dropdown-menu">
	            {foreach from=$year_options item=year}
	            	<a class="dropdown-item" href='{$URL}?mode=2&title={$year}&year={$year}'>{$year}</a>
	            {/foreach}
			</div>
		</li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" href='{$URL}?mode=1&title=フランス人がときめいた日本の美術館&fra=1'>FRA</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="ex.php" target="_blank">EXHIBITION</a>
        </li>
        <li class="nav-item">
